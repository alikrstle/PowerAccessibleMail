...
OutputDir=release\installer-gmail-api-limited
...
#ifdef SignedBuild
SignTool=PowerAccessibleMailLimited
...
[Files]
#ifdef SignedBuild
Source: "release\win-x64-gmail-api-limited\Power Accessible Mail\Power Accessible Mail.exe"; DestDir: "{app}"; Flags: ignoreversion signcheck
#else
Source: "release\win-x64-gmail-api-limited\Power Accessible Mail\Power Accessible Mail.exe"; DestDir: "{app}"; Flags: ignoreversion
#endif
Source: "release\win-x64-gmail-api-limited\Power Accessible Mail\*"; Excludes: "Power Accessible Mail.exe"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
