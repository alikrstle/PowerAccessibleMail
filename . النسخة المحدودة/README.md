...
- تظهر الرسائل في الوضع العادي كعناصر قائمة بلا مربعات اختيار. استخدم `Ctrl+Shift+Space` لتفعيل التحديد المتعدد وإظهار المربعات، ثم حدّد بالمسافة أو بالفأرة ونفّذ إجراءات القراءة والنجمة والتثبيت والحذف دفعة واحدة.
