...
يفحص البرنامج ملف تحديثات JSON على خادم HTTPS بعد بدء التشغيل، ويمكن إجراء الفحص يدويا من قائمة "المساعدة" عبر "تحديث البرنامج". عند وجود إصدار أحدث تظهر نافذة واضحة تحتوي على زري "تحديث الآن" و"إغلاق". يفتح زر التحديث رابط المثبت الجديد.
...
{
  "version": "1.2.8",
  "download_url": "https://example.com/PowerAccessibleMailSetup-1.2.8-win-x64.exe",
