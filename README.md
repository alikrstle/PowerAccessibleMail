...
2. استخدم وسم إصدار مثل `v1.4.0`.
3. للاختبار المحدود، ارفع `PowerAccessibleMailSetup-1.4.0-win-x64-UNSIGNED.exe` إلى الـPre-release فقط. للإصدار المستقر، تحقق أن النسخة غير الموسومة بـ`UNSIGNED` موقعة توقيعا صالحا.
...
```json
{
  "version": "1.4.0",
  "downloads": {
    "x64": "https://example.com/PowerAccessibleMailSetup-1.4.0-win-x64.exe",
    "x86": "https://example.com/PowerAccessibleMailSetup-1.4.0-win-x86.exe"
  },
