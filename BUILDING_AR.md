...
بناء التطبيق هو `onedir` ومن دون UPX. يستخدم المثبت غير الموقع ضغط `zip` غير متصلب، ويشغّل المحدّث المثبت في الوضع التلقائي فقط بعد تنزيله إلى مجلد تحديثات Power Accessible Mail والتحقق من بصمة SHA-256؛ ولا يتجاوز UAC أو SmartScreen أو Defender. لا تمنع هذه الاحتياطات الإنذارات الكاذبة بصورة مضمونة، لكنها تقلل السلوكيات التي قد تبدو ملتبسة.
